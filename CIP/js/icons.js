...
(() => {
  ...
  const ICONS = {
    ...
    /**
     * A warning symbol used for "What Went Wrong" items.  A
     * triangle with an exclamation mark inside conveys caution and
     * draws attention to ethical missteps.  The circle at the
